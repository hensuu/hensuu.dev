<template>
  <div>
    <div class="h-110 p-10">
      <div class="flex flex-col gap-10 items-center justify-center h-full">
        <div class="flex flex-row items-center justify-center gap-2">
          <span class="text-4xl h-full font-medium text-orange-400 mb-10">↘</span>
          <span class="text-5xl/17 tracking-wide inline-block w-min sm:w-62 md:w-fit font-medium whitespace-nowrap bg-clip-text text-transparent bg-linear-to-r from-orange-400 via-purple-400 to-green-400 ">Hi, <wbr>it's me, <wbr>hensuu!</span>
          <LogoSticker
            class="ml-3 -mb-2 w-18 h-18 shrink-0 from-cyan-600 to-green-600 stroke-[1.7] drop-shadow-md rotate-10"
          />
        </div>
        <div class="flex flex-col sm:flex-row items-center justify-center sm:gap-2">
          <div class="bg-orange-50 border border-orange-200 px-3 py-1 rounded-lg">
            <span class="text-orange-800 font-medium text-md">🧑‍💻 Developer</span>
          </div>
          <span class="text-orange-800 font-normal text-xl mb-0.5">+</span>
          <div class="bg-orange-50 border border-orange-200 px-3 py-1 rounded-lg">
            <span class="text-orange-800 font-medium text-md whitespace-nowrap">🎵 Vocaloid Producer</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="p-10 bg-white/35">
      <div class="flex flex-col md:flex-row gap-8">
        <div class="flex-1 flex flex-col gap-4">
          ...
          <div class="text-gray-950 text-justify font-medium text-base/relaxed leading-6 space-y-2">
            <p>
        ...
        <div class="flex-1 flex flex-col gap-4">
          <span class="text-magenta-800/70 text-3xl relative ">
            → Work Experiences
          </span>
          <div class="text-gray-950 space-y-2">
            <WorkExperience
